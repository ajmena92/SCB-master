...
| Control de Marcas Comedor | `comedor` | Operación | `/admin/comedor/operacion` | Completo | `comedor.registrar` | `comedor.operacion` | Kiosco independiente con hora del servidor, reserva, tiquete y auditoría. |
