...
class RepositorioFalso:
    def listar(self, incluir_inactivos: bool = False) -> list[dict]:
        return [{"id_beneficio": 1, "nombre": "Comedor", "descripcion": None, "dias_permitidos": 5, "activo": True}]
...
def test_normaliza_catalogo_y_asignacion() -> None:
    ...
    beneficio = servicio.crear(BeneficioEntrada(nombre="  Comedor  ", descripcion="  Apoyo  "), 3, "WEB")
