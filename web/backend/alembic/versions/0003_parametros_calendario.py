...
def upgrade() -> None:
    op.create_table(
        "parametro",
        sa.Column("id_parametro", sa.Integer, primary_key=True),
    ...
    op.create_table(
        "calendario",
        sa.Column("id_calendario", sa.Integer, primary_key=True),
        sa.Column("fecha", sa.DateTime, nullable=False),
        sa.Column("habilitado", sa.Boolean, nullable=False, server_default=sa.true()),
        sa.UniqueConstraint("fecha", name="uq_calendario_fecha"),
        schema="menu",
    )
