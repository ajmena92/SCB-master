...
def upgrade() -> None:
    op.create_table("fotografia", sa.Column("id_fotografia", sa.Integer, primary_key=True),
                    sa.Column("id_estudiante", sa.Integer, sa.ForeignKey("estudiantes.estudiante.id_estudiante"), nullable=False),
                    sa.Column("contenido", sa.LargeBinary, nullable=False),
                    sa.Column("tipo_contenido", sa.String(80), nullable=False),
                    sa.UniqueConstraint("id_estudiante", name="uq_fotografia_estudiante"), schema="estudiantes")
    op.create_table("resumen", sa.Column("id_resumen", sa.Integer, primary_key=True),
                    ...
                    sa.UniqueConstraint("fecha", name="uq_resumen_fecha"), schema="reportes")
