...
describe("destinoSesion", () => {
  it("resuelve destinos administrativos y estudiantiles", () => {
    ...
    expect(destinoSesion({ tipo: "administracion", vinculacionPendiente: true })).toBe(
      "/admin/vinculacion-inicial",
    );
    expect(destinoSesion({ tipo: "administracion", cambioContrasenaObligatorio: true })).toBe(
