...
export const OPERACIONES_API: readonly OperacionApi[] = [
  ...
  {
    metodo: "POST",
    ruta: "/api/v1/comedor/registros",
    operacionId: "registrar_api_v1_comedor_registros_post",
  },
  {
    metodo: "POST",
  ...
  {
    metodo: "POST",
    ruta: "/api/v1/soporte/solicitudes",
    operacionId: "crear_api_v1_soporte_solicitudes_post",
  },
  {
    metodo: "GET",
