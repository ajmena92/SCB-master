...
import { CardThumbnail, VistaCarnetEstudiante } from "../componentes/CarnetEstudiante";
...
describe("carnet del estudiante", () => {
  it("muestra carnet provisional y enlaces canónicos", async () => {
    ...
    expect(container.querySelector('a[href="/api/v1/estudiantes/8/carnet.pdf"]')).not.toBeNull();
