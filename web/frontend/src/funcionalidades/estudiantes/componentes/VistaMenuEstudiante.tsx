...
type PropsVistaMenu = {
  ...
  registrarAsistencia: (tipo: "confirm" | "decline") => void;
};

const ICONOS_COMPONENTE: Record<string, typeof Soup> = {
  Principal: Soup,
        ...
        >
          ...
          {estado.sinTiquete && (
            <p
              ...
              data-testid="confirmacion-sin-tiquete"
            >
