...
export function NavegacionEstudiante({
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-30 border-t border-border bg-card px-4 pb-[calc(env(safe-area-inset-bottom)+0.5rem)] pt-2 shadow-[0_-12px_35px_rgb(var(--primary)_/_0.18)] sm:bottom-5 sm:left-1/2 sm:right-auto sm:w-[min(22rem,calc(100%-2rem))] sm:-translate-x-1/2 sm:rounded-[1.75rem] sm:border sm:border-border sm:p-2"
    >
