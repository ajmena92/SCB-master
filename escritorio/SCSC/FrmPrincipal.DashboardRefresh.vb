...
Public Partial Class FrmPrincipal
    ...
    Private Sub ResetNextRefreshCountdown()
        If Not _dashboardAutoRefreshEnabled Then
            ...
            Exit Sub
        End If
        _nextDashboardRefreshAt = ServerClock.Now().AddMilliseconds(_dashboardRefreshIntervalMs)
        UpdateNextRefreshBadge()
    End Sub
    ...
    Private Sub UpdateNextRefreshBadge()
        ...
        Dim remaining As TimeSpan = _nextDashboardRefreshAt.Subtract(ServerClock.Now())
