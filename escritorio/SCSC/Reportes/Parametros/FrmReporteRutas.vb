...
Public Class FrmReporteRutas
    ...
    Private Sub ConfigureResponsiveLayout()
        ...
        GroupParametros.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        PanelAcciones.Anchor = AnchorStyles.Bottom Or AnchorStyles.Right

        FecIni.Anchor = AnchorStyles.Top Or AnchorStyles.Left
        FecFinal.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        CbTipoUsuario.Anchor = AnchorStyles.Top Or AnchorStyles.Left
        CbHorario.Anchor = AnchorStyles.Top Or AnchorStyles.Left
        RbGeneral.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        RbDetallo.Anchor = AnchorStyles.Top Or AnchorStyles.Right
    End Sub
