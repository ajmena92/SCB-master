...
Public Class FrmRutas
    ...
    Private Sub Buscar_Click(sender As Object, e As EventArgs) Handles Buscar.Click
        Try
            ...
            request.Keys = Llave
            Dim codigoActual As String = txtCodRuta.Text
            Dim codigoSeleccionado As String = codigoActual
            If Not SearchDialogHelper.TrySelectSingleValue(Me, request, codigoActual, codigoSeleccionado) Then
                txtCodRuta.Text = codigoActual
                Exit Sub
            End If
            txtCodRuta.Text = codigoSeleccionado
    ...
    Private Sub txtCodRuta_Validated(sender As Object, e As EventArgs) Handles txtCodRuta.Validated
        Dim textoCodigo As String = If(txtCodRuta.Text, String.Empty).Trim()
        Dim Cedula As String = textoCodigo.Replace(ControlCarnet, String.Empty).Trim()
    ...
    Private Function Validacion() As Boolean
        Dim codigoRuta As String = If(txtCodRuta.Text, String.Empty).Trim()

        If codigoRuta.Length = 0 Then
    ...
    Private Function ObtenerIdRutaDesdeTag() As Integer
        ...
        End If
        Dim codigoRuta As String = If(txtCodRuta.Text, String.Empty).Trim()
        If Integer.TryParse(codigoRuta, parsed) Then
            Return parsed
        End If
        Return 0
    End Function
