...
Public Class FrmParametrosSistema
    ...
    Private Sub FrmParametrosSistema_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        End If
        Try
            If Not SeguridadPermisosSistema.IsUsuarioAutorizadoParaParametros(CodigoUsuario) Then
    ...
    Private Sub CargarDatos(Optional ByVal cnExistente As SqlClient.SqlConnection = Nothing)
        ...
        Try
            ...
            AddParam("PermitirMarcaTardia", cfg.PermitirMarcaTardia.ToString())
            AddParam("ApagaAdvertenciaTransporte", cfg.ApagaAdvertenciaTransporte.ToString())
    ...
    Private Function LeerDesdeGrid() As ParametroSistemaService.ParametroSistemaConfig
        ...
        cfg.PermitirMarcaTardia = ParseBool(ObtenerValor("PermitirMarcaTardia"))
        cfg.ApagaAdvertenciaTransporte = ParseBool(ObtenerValor("ApagaAdvertenciaTransporte"))
