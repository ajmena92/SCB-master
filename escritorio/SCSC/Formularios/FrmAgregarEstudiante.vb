...
Public Class FrmAgregarEstudiante
    ...
    Private _cedulaOriginal As String = String.Empty
    Private _registroCargado As Boolean = False
    ...
    Sub LimpiarPantalla(Optional pFocus As Boolean = True)
        TxtCedula.Tag = 0
        _cedulaOriginal = String.Empty
        _registroCargado = False
    ...
    Private Sub TxtCedula_Validated(sender As Object, e As EventArgs) Handles TxtCedula.Validated
        ...
        Dim Cedula As String = textoCedula.Replace(ControlCarnet, String.Empty).Trim()
        Dim Ds As New DataSet
        Dim Valores(), Llave() As FuncionesDB.Campos
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        Dim Valores(), Llave() As FuncionesDB.Campos
        Try
            Dim cedulaActual As String = TxtCedula.Text.Trim()
            If String.IsNullOrWhiteSpace(cedulaActual) Then
                MsgBox("Ingrese la cédula del estudiante.", MsgBoxStyle.Exclamation)
                TxtCedula.Focus()
                Exit Sub
            End If

            If _registroCargado AndAlso Not String.Equals(cedulaActual, _cedulaOriginal, StringComparison.OrdinalIgnoreCase) Then
                MsgBox("La cédula no se puede modificar porque es la llave del estudiante.", MsgBoxStyle.Exclamation)
                TxtCedula.Text = _cedulaOriginal
                TxtCedula.Focus()
                Exit Sub
            End If
            ...
            Valores = Cls.InicializarArray
            Llave = Cls.InicializarArray
            Cls.ArmaValor(Llave, "Cedula", cedulaActual)
            Cls.ArmaValor(Valores, "Cedula", cedulaActual)
    ...
    Private Sub BtnEliminar_Click(sender As Object, e As EventArgs) Handles BtnEliminar.Click
        ...
        Try
            Dim cedulaActual As String = If(TxtCedula.Text, String.Empty).Trim()
            If cedulaActual.Length > 0 Then
