...
Public Module CodigoGeneral
    ...
    Function ObtenerValorParametroConexion(ByVal pBuscar As String, Optional ByVal pBuscarAux As String = ".") As String
        Dim builder As SqlConnectionStringBuilder = BuildConnectionStringBuilder()
        Dim primaryKey As String = If(pBuscar, String.Empty).Trim().ToLowerInvariant()
        Dim alternateKey As String = If(pBuscarAux, String.Empty).Trim().ToLowerInvariant()
    ...
    Function ObtenerParametroConexion(ByVal pBuscar As String, Optional ByVal pBuscarAuxiliar As String = ".") As String
        ...
        If builder.IntegratedSecurity Then
            Return "Conexion de Confianza"
        End If

        Dim value As String = ObtenerValorParametroConexion(pBuscar, pBuscarAuxiliar)
        If String.IsNullOrWhiteSpace(value) Then
            Return "No hay parámetro de busqueda definido."
        End If

        Return value.Replace(";", "")
    End Function

    Private Function BuildConnectionStringBuilder() As SqlConnectionStringBuilder
