...
Public Class ImportacionExcelService
    ...
    Public Class ImportacionResultadoCarga
        Public Property RegistrosActualizados As Integer
        Public Property RegistrosInsertados As Integer
    End Class
    ...
    Public Class ImportacionAuditoria
        ...
        Public Property ColumnasNoCriticasFaltantes As String
    ...
    Public Function ImportarUsuariosNormalizadosEnLote(ByVal tabla As DataTable,
                                                       ByVal tipoUsuario As Integer,
                                                       ByVal idHorario As Integer,
                                                       ByVal cn As SqlConnection,
                                                       ByVal pTransac As SqlTransaction,
                                                       Optional ByVal modo As ImportacionExcelModo = ImportacionExcelModo.ActualizarTodos) As ImportacionResultadoCarga
        Dim resultado As New ImportacionResultadoCarga()
        ...
        If modo = ImportacionExcelModo.ActualizarTodos Then
            resultado.RegistrosActualizados = ActualizarUsuariosExistentes(tipoUsuario, idHorario, cn, pTransac)
        End If
        resultado.RegistrosInsertados = InsertarUsuariosNuevos(tipoUsuario, idHorario, cn, pTransac)
        Return resultado
    End Function
    ...
    Private Function ActualizarUsuariosExistentes(ByVal tipoUsuario As Integer,
                                                  ByVal idHorario As Integer,
                                                  ByVal cn As SqlConnection,
                                                  ByVal pTransac As SqlTransaction) As Integer
        Dim sql As String =
            "UPDATE U" &
    ...
    Private Function InsertarUsuariosNuevos(ByVal tipoUsuario As Integer,
                                            ByVal idHorario As Integer,
                                            ByVal cn As SqlConnection,
                                            ByVal pTransac As SqlTransaction) As Integer
        Dim sql As String =
...
" ArchivoOrigen, TipoUsuario, IdHorario, FilasOrigen, FilasValidas, FilasOmitidasEstado, FilasOmitidasCedula, FilasDuplicadas, FilasSinFechaNac, DesactivarNoImportados, Exito, Mensaje, UsuarioEjecucion, ModoImportacion, ResumenEstructura, ColumnasNoCriticasFaltantes, FaltoColumnaEstado, RegistrosActualizados, RegistrosInsertados)" &
" VALUES (" &
" @ArchivoOrigen, @TipoUsuario, @IdHorario, @FilasOrigen, @FilasValidas, @FilasOmitidasEstado, @FilasOmitidasCedula, @FilasDuplicadas, @FilasSinFechaNac, @DesactivarNoImportados, @Exito, @Mensaje, @UsuarioEjecucion, @ModoImportacion, @ResumenEstructura, @ColumnasNoCriticasFaltantes, @FaltoColumnaEstado, @RegistrosActualizados, @RegistrosInsertados);"
        ...
        Using cmd As New SqlCommand(sql, cn, pTransac)
            ...
            cmd.Parameters.Add("@ModoImportacion", SqlDbType.NVarChar, 50).Value = If(auditoria.ModoImportacion, String.Empty)
            cmd.Parameters.Add("@ResumenEstructura", SqlDbType.NVarChar, -1).Value = If(auditoria.ResumenEstructura, String.Empty)
            cmd.Parameters.Add("@ColumnasNoCriticasFaltantes", SqlDbType.NVarChar, 500).Value = If(auditoria.ColumnasNoCriticasFaltantes, String.Empty)
            cmd.Parameters.Add("@FaltoColumnaEstado", SqlDbType.Bit).Value = auditoria.FaltoColumnaEstado
            cmd.Parameters.Add("@RegistrosActualizados", SqlDbType.Int).Value = auditoria.RegistrosActualizados
            cmd.Parameters.Add("@RegistrosInsertados", SqlDbType.Int).Value = auditoria.RegistrosInsertados
            cmd.ExecuteNonQuery()
        End Using
    End Sub
...
"        ModoImportacion NVARCHAR(50) NULL, " &
"        ResumenEstructura NVARCHAR(MAX) NULL, " &
"        ColumnasNoCriticasFaltantes NVARCHAR(500) NULL, " &
"        FaltoColumnaEstado BIT NOT NULL CONSTRAINT DF_ImportacionExcelAuditoria_FaltoEstado DEFAULT(0), " &
"        RegistrosActualizados INT NOT NULL CONSTRAINT DF_ImportacionExcelAuditoria_RegActualizados DEFAULT(0), " &
"        RegistrosInsertados INT NOT NULL CONSTRAINT DF_ImportacionExcelAuditoria_RegInsertados DEFAULT(0) " &
"    ); " &
...
"    IF COL_LENGTH('dbo.ImportacionExcelAuditoria', 'ModoImportacion') IS NULL " &
"        ALTER TABLE dbo.ImportacionExcelAuditoria ADD ModoImportacion NVARCHAR(50) NULL; " &
"    IF COL_LENGTH('dbo.ImportacionExcelAuditoria', 'ResumenEstructura') IS NULL " &
"        ALTER TABLE dbo.ImportacionExcelAuditoria ADD ResumenEstructura NVARCHAR(MAX) NULL; " &
"    IF COL_LENGTH('dbo.ImportacionExcelAuditoria', 'ColumnasNoCriticasFaltantes') IS NULL " &
"        ALTER TABLE dbo.ImportacionExcelAuditoria ADD ColumnasNoCriticasFaltantes NVARCHAR(500) NULL; " &
"    IF COL_LENGTH('dbo.ImportacionExcelAuditoria', 'FaltoColumnaEstado') IS NULL " &
"        ALTER TABLE dbo.ImportacionExcelAuditoria ADD FaltoColumnaEstado BIT NOT NULL CONSTRAINT DF_ImportacionExcelAuditoria_FaltoEstado DEFAULT(0); " &
"    IF COL_LENGTH('dbo.ImportacionExcelAuditoria', 'RegistrosActualizados') IS NULL " &
"        ALTER TABLE dbo.ImportacionExcelAuditoria ADD RegistrosActualizados INT NOT NULL CONSTRAINT DF_ImportacionExcelAuditoria_RegActualizados DEFAULT(0); " &
"    IF COL_LENGTH('dbo.ImportacionExcelAuditoria', 'RegistrosInsertados') IS NULL " &
"        ALTER TABLE dbo.ImportacionExcelAuditoria ADD RegistrosInsertados INT NOT NULL CONSTRAINT DF_ImportacionExcelAuditoria_RegInsertados DEFAULT(0); " &
"END;"
