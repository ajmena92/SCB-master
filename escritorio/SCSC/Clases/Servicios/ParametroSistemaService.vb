...
Public Class ParametroSistemaService
    ...
    Public Class ParametroSistemaConfig
        ...
        Public Property PermitirMarcaTardia As Boolean
        Public Property ApagaAdvertenciaTransporte As Boolean
    ...
    Public Function ObtenerFila1(ByVal cn As SqlConnection) As ParametroSistemaConfig
        ...
        Using cmd As New SqlCommand(sql, cn)
            cmd.Parameters.Add("@Id", SqlDbType.Int).Value = ParametroFilaUnicaId
            Using rd As SqlDataReader = cmd.ExecuteReader()
                ...
                cfg.PermitirMarcaTardia = LeerBool(rd, "PermitirMarcaTardia", False)
                cfg.ApagaAdvertenciaTransporte = LeerBool(rd, "ApagaAdvertenciaTransporte", False)
...
"BEGIN TRY" & vbCrLf &
"    INSERT INTO Parametro (Id, Institucion, CodPresupuestario, Ubicacion, Leyenda, ControlCarnet, PrecioDocente, PrecioEstudiante, PermitirSinMarcaTransporte, PermitirMarcaTardia, ApagaAdvertenciaTransporte, DesactivarNoImportadosExcel, AuditarImportacionExcel)" & vbCrLf &
"    VALUES (@Id, N'', N'', N'', N'', N'', 0, 0, 0, 0, 0, 1, 1);" & vbCrLf &
"END TRY" & vbCrLf &
"BEGIN CATCH" & vbCrLf &
"    BEGIN TRY" & vbCrLf &
...
" PermitirMarcaTardia=@PermitirMarcaTardia," & vbCrLf &
" ApagaAdvertenciaTransporte=@ApagaAdvertenciaTransporte," & vbCrLf &
...
" AuditarImportacionExcel=@AuditarImportacionExcel" & vbCrLf &
        ...
        Using cmd As New SqlCommand(sql, cn)
            cmd.Parameters.Add("@Id", SqlDbType.Int).Value = ParametroFilaUnicaId
            cmd.Parameters.Add("@Institucion", SqlDbType.NVarChar, 250).Value = If(cfg.Institucion, String.Empty)
            cmd.Parameters.Add("@CodPresupuestario", SqlDbType.NVarChar, 120).Value = If(cfg.CodPresupuestario, String.Empty)
            cmd.Parameters.Add("@Ubicacion", SqlDbType.NVarChar, 250).Value = If(cfg.Ubicacion, String.Empty)
            cmd.Parameters.Add("@Leyenda", SqlDbType.NVarChar, -1).Value = If(cfg.Leyenda, String.Empty)
            cmd.Parameters.Add("@ControlCarnet", SqlDbType.NVarChar, 120).Value = If(cfg.ControlCarnet, String.Empty)
            Dim precioDocenteParam As SqlParameter = cmd.Parameters.Add("@PrecioDocente", SqlDbType.Decimal)
            precioDocenteParam.Precision = 18
            precioDocenteParam.Scale = 2
            precioDocenteParam.Value = cfg.PrecioDocente
            Dim precioEstudianteParam As SqlParameter = cmd.Parameters.Add("@PrecioEstudiante", SqlDbType.Decimal)
            precioEstudianteParam.Precision = 18
            precioEstudianteParam.Scale = 2
            precioEstudianteParam.Value = cfg.PrecioEstudiante
            cmd.Parameters.Add("@PermitirSinMarcaTransporte", SqlDbType.Bit).Value = cfg.PermitirSinMarcaTransporte
            cmd.Parameters.Add("@PermitirMarcaTardia", SqlDbType.Bit).Value = cfg.PermitirMarcaTardia
            cmd.Parameters.Add("@ApagaAdvertenciaTransporte", SqlDbType.Bit).Value = cfg.ApagaAdvertenciaTransporte
            cmd.Parameters.Add("@DesactivarNoImportadosExcel", SqlDbType.Bit).Value = cfg.DesactivarNoImportadosExcel
            cmd.Parameters.Add("@AuditarImportacionExcel", SqlDbType.Bit).Value = cfg.AuditarImportacionExcel
            cmd.ExecuteNonQuery()
        End Using
    End Sub
...
" PermitirMarcaTardia=0," & vbCrLf &
" ApagaAdvertenciaTransporte=0," & vbCrLf &
